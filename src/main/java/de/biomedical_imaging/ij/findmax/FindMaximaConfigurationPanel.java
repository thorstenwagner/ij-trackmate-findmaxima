 ...
 */
public class FindMaximaConfigurationPanel extends ConfigurationPanel
{
	 ...
	 */
	public FindMaximaConfigurationPanel( final Settings settings, final Model model, final String infoText, final String detectorName )
	{
	...
	protected void initGUI()
	{
		try
		{
			...
			{
				jLabelThreshold = new JLabel("Tolerance:");
